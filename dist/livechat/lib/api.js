...
exports.livechat = {
    config: (params) => api.get('livechat/config', params, false).then((r) => r),
    room: (credentials) => api.get('livechat/room', credentials, false).then((r) => r),
    ...
    loadMessages: (id, params) => api.get(`livechat/messages.history/${id}`, params, false).then((r) => r),
